...
mappings = [
    ...
    ["Esophagogastric Adenocarcinoma", "Esophageal carcinoma or Stomach adenocarcinoma"],
    ...
    ["Cervical Squamous Cell Carcinoma", "Cervical squamous cell carcinoma and endocervical adenocarcinoma"],
    ...
    ["Cervical Adenocarcinoma", "Cervical squamous cell carcinoma and endocervical adenocarcinoma"],
    ...
    ["Mixed Cervical Carcinoma", "Cervical squamous cell carcinoma and endocervical adenocarcinoma"],
    ...
    ["Hepatocellular Carcinoma plus Intrahepatic Cholangiocarcinoma", "Liver hepatocellular carcinoma and Cholangiocarcinoma"],
    ["Glassy Cell Carcinoma of the Cervix", "Cervical squamous cell carcinoma and endocervical adenocarcinoma"],
    ...
    ["Small Cell Carcinoma of the Cervix", "Cervical squamous cell carcinoma and endocervical adenocarcinoma"],
    ["Chordoma", "Sarcoma"],
...
primary = pd.Series(df_list['TCGA_project'].values,index=df_list['OncotreePrimaryDisease'].values).to_dict()

double_mapped = list(df_list[df_list['TCGA_project'].str.contains(' or')]['OncotreePrimaryDisease'].unique())
...
for key in sub_type.keys():
    sub_type[key] = {k.lower():v.lower() for k,v in sub_type[key].items() if v is not None}
